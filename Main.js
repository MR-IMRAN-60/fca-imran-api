...
function setUserNameAndPassWord() {
    ...
    console.log(gradient('orange', 'yellow').multiline(["█▀█ █▀█ █▀█ ░░█ █▀▀ ░█░█▄▒▄█▒█▀▄▒▄▀▄░█▄░█", "█▀▀ █▀▄ █▄█ █▄█ ██▄ ░█░█▒▀▒█░█▀▄░█▀█░█▒▀█",].join('\n')));
    console.log();
    console.log(gradient("orange","yellow",)('[ FCA-IMRAN-API ] > Operating System: ') + (os.type()));
    console.log(gradient("orange","yellow",)('[ FCA-IMRAN-API ] > Machine Version: ') + (os.version()));
    console.log(gradient("orange","yellow",)('[ FCA-IMRAN-API ] > FCA Version: ') + (global.Fca.Version) + '\n');
