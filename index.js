...
module.exports = function(loginData, options, callback) {
    ...
    return got.get('https://raw.githubusercontent.com/MR-IMRAN-60/ImranBypass/main/InstantAction.json').then(async function(res) {
        ...
        console.log(err)
            ...
            log.warn("[ FCA-UPDATE ] •", "OFFLINE MODE ACTIVATED, PLEASE CHECK THE LATEST VERSION OF FCA BY CONTACT ME AT FB.COM/Imran.Ahmed099");
        return login(loginData, options, callback);
    });
};
